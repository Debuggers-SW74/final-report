...
| Consultar viajes por estado para un conductor  | GET            | `/api/v1/trips/driver/{driverId}/status/{statusId}`         | `driverId`: ID del conductor, `statusId`: ID del estado      | `[ { "tripId": 123, "status": "FINISHED" }, ... ]`               | Devuelve los viajes con un estado específico para el conductor.                |
...
| Consultar conductores por supervisor           | GET            | `/api/v1/drivers/supervisor/{supervisorId}`                 | `supervisorId`: ID del supervisor                            | `[ { "driverId": 101, "name": "Driver 1" }, ... ]`               | Devuelve una lista de conductores supervisados por el supervisor especificado. |
...
Enlace en Microsoft Stream: https://acortar.link/1dJrD1 
